import{_ as b}from"./preload-helper.ygWHROA3.js";import{P as C}from"./photoswipe-lightbox.esm.DPG_9Fhr.js";import"./hoisted.TFVhu6gM.js";import"./hoisted.CNsk5I35.js";const x=500,A="auto",E=300,a=24,c="--_masonry-layout-col-count",h="--_masonry-layout-gap",g=1,p=new Map;function r(s,t,o){const e=parseFloat(s.getAttribute(t)||"");return isNaN(e)?o:e}function y(s,t,o){return isNaN(t)?Math.max(1,Math.ceil(s/o)):t}function _(s,t,o){const e=p.get(o);e!=null&&window.clearTimeout(e),p.set(o,window.setTimeout(s,t))}function v(s){let t=0,o=1/0;return s.forEach((e,n)=>{e<o&&(o=e,t=n)}),t}const f=document.createElement("template");f.innerHTML=`
  <style>
    :host {
      display: flex;
