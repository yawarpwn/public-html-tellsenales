...
const k="modulepreload",L=function(o){return"/"+o},v={},p=function(e,n,f){let u=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),i=c?.nonce||c?.getAttribute("nonce");u=Promise.all(n.map(r=>{if(r=L(r),r in v)return;v[r]=!0;const l=r.endsWith(".css"),h=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${h}`))return;const a=document.createElement("link");if(a.rel=l?"stylesheet":k,l||(a.as="script",a.crossOrigin=""),a.href=r,i&&a.setAttribute("nonce",i),document.head.appendChild(a),l)return new Promise((t,s)=>{a.addEventListener("load",t),a.addEventListener("error",()=>s(new Error(`Unable to preload CSS for ${r}`)))})}))}return u.then(()=>e()).catch(c=>{const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=c,window.dispatchEvent(i),!i.defaultPrevented)throw c})};console.log(`®Tell Señales - Todos los derechos reservados 🤖
https://www.indecopi.gob.pe/documents/20182/143803/DecretoLegislativo822.pdf `);const E=document.querySelector("#search-product"),y=E.querySelector("span"),d=document.querySelector("#modal-search"),T=d.querySelector(".Search-Cancel");let g=!1;const _=`
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
